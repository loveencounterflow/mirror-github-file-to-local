(async function() {
  'use strict';
  var $, GUY, Nn, alert, debug, demo_execa, demo_walk_js_paths_from_coffee_path, echo, execa, gold, help, info, inspect, lines_of, log, mirror_github_file_to_local_json, plain, praise, reverse, rpr, urge, warn, whisper, white;
  ...
  Nn = class Nn {
    ...
    * walk_additional_paths(path) {
    ...
    compile_cfg(cfg) {
      ...
      Object.assign(R, this.paths_by_repo_from_paths(R.files));
      R.checkouts = {};
